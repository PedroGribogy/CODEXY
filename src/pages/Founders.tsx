...
const Founders = () => {
  ...
  return (
    <div id="founders" className="min-h-screen pt-24 pb-16 bg-gradient-to-br from-blue-50 to-white">
                  ...
                  <div className="flex flex-col h-full">
                    ...
                    <div className="space-y-6 flex-grow">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <h5 className="font-medium text-blue-900">Formação</h5>
                          <p className="text-gray-700">{founder.details.education}</p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <h5 className="font-medium text-blue-900">Experiência</h5>
                          <p className="text-gray-700">{founder.details.experience}</p>
                        </div>
                      </div>
                      ...
                      <div>
                        <div className="flex items-center gap-2 mb-2">
                          ...
                          <h5 className="font-medium text-blue-900">Conquistas</h5>
                        </div>
                      ...
                      <div>
                        <div className="flex items-center gap-2 mb-2">
                          ...
                          <h5 className="font-medium text-blue-900">Especialidades</h5>
                        </div>
                        <ul className="space-y-1 text-sm text-gray-700">
